...
BLOG_AUTHOR = "Devminz"  # (translatable)
BLOG_TITLE = "Devminz TechBlog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://devminz.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://devminz.github.io/"
BLOG_EMAIL = "devminz.github.io"
BLOG_DESCRIPTION = "Techology Blog by Devminz"  # (translatable)
...
POSTS = (
    ...
    ("posts/devops/*.rst", "devops", "post.tmpl"),
    ("posts/*.org", "posts", "post.tmpl"), 
    ("posts/devops/*.org", "devops", "post.tmpl"),
)
PAGES = (
...
# is in the manual.
COMMENT_SYSTEM_ID = "devminzgithubio"
